...
data_dir = 'PATH/TO/NYUDv2/ESTIMATION';
fprintf('Data dir: %s\n', data_dir);
...
gtDir= 'PATH/TO/NYUDv2/GROUNDTRUTH';
resDir = fullfile(data_dir, 'nms');
edgesEvalDir('resDir',resDir,'gtDir',gtDir, 'thin', 1, 'pDistr',{{'type','parfor'}},'maxDist',0.0372);%0.011

figure; edgesEvalPlot(resDir,'NYUDv2');
close all;

...
data_dir = 'PATH/TO/BSDS500/ESTIMATION';
fprintf('Data dir: %s\n', data_dir);
...
gtDir= 'PATH/TO/BSDS500/GROUNDTRUTH';
resDir = fullfile(data_dir, 'nms');
edgesEvalDir('resDir',resDir,'gtDir',gtDir, 'thin', 1, 'pDistr',{{'type','parfor'}},'maxDist',0.0209);%0.0075

figure; edgesEvalPlot(resDir,'BSDS500');
close all;
